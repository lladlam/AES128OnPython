...
### V2.3.0-beta4
1. **修复语法错误**：修复了 main.py 中因字符串转义导致的 SyntaxError，解决了程序无法启动的问题
2. **功能合并与增强**：
   - 合并了 main_fixed.py 中的修复，包括密码修改后删除旧密码文件的逻辑（增强安全性）
   - 修复了窗口创建的兼容性问题（确保 GUI 在不同环境下正确启动）
   - 集成了 V2.3.0-beta3 的命令行功能、V2.3.0-beta2 的密码安全修复和 V2.3.0-beta1 的其他全部功能
3. **稳定性提升**：修复了因语法错误导致的潜在崩溃点，提高了程序整体稳定性
