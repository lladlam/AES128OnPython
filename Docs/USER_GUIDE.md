...
### V2.4.0-beta2
- 新增功能：添加了StreamCipher类，支持使用ChaCha20-Poly1305算法进行流式加密，特别适合处理大文件
- 新增功能：在设置界面中新增了加密方式选择功能，用户可以在AES和STREAM之间切换
- 新增功能：当加密方式更改时自动重新加密所有文件
- 其他：保持对原有AES加密文件的向后兼容性，流式加密可有效处理大文件而不会占用过多内存
