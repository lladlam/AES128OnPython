...
### V2.4.0-beta2.1
- 新增功能：添加 ChaCha20-Poly1305 加密算法，支持流式加密解密
- 新增功能：添加设置选项，包括加密方式选择、版本号显示开关和复制选项
- 新增功能：用户可在 AES-128、AES-192、AES-256 和 ChaCha20-Poly1305 之间切换
- 新增功能：用户可选择是否在界面中显示版本号
- 新增功能：用户可选择复制时使用解密文件或加密文件
- 变更：重构加密解密逻辑以支持多种算法
- 变更：保留对原有加密文件的向后兼容性
