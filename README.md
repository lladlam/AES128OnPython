...
- **版本**：V2.4.0-beta2.1
- **发布日期**：2025年
- **功能**：加密/解密/查看 + 源码保护 + 多目录支持 + 自动删除 + 密码修改 + 命令行支持 + 修复语法错误 + 新增右键删除功能 + 新增多加密方式支持(ChaCha20-Poly1305) + 新增设置选项(加密方式/版本显示/复制选项)

## 更新日志

### V2.4.0-beta2.1
- 🔐 **新增多加密方式支持**：添加ChaCha20-Poly1305加密算法，支持流式加密解密
- ⚙️ **新增设置选项**：添加加密方式选择、版本号显示开关和复制选项
- 🎛️ **加密方式选择**：用户可在AES-128、AES-192、AES-256和ChaCha20-Poly1305之间切换
- 👁️ **版本显示控制**：用户可选择是否在界面中显示版本号
- 📋 **复制功能增强**：用户可选择复制时使用解密文件或加密文件
- 🔧 **代码优化**：重构加密解密逻辑以支持多种算法
- 🛡️ **向后兼容**：保留对原有加密文件的支持
